...
class FluxByClass:
    ...
    def process_flux(self, species_list, tot_rop_dct):
        ...
        for species in species_list:
            ...
            tot_rop_df = tot_rop_df.groupby(level=0).sum() # sum rxns with same indexes LPM aggiunto qui
...
def merge_maps_byspecies(sorted_dfs_dct, tosum: bool = False):
    ...
    tosum: specifies if you have to sum the flux for each species or not
    Args:
