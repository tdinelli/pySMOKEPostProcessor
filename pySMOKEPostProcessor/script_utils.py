...
# then ready to plot
def cumulative_rates(simul_fld,
            kin_xml_fld,
            species_list,
            rate_type, x_axis,
            n_of_rxns = 100,
...
def reactionrates_byclasses(simul_fld,
            kin_xml_fld,
            rxns_sorted_df,
            sortlists,
            x_axis,
            filter_by_species = [], # filter by species list based on global ropa
            filter_dcts = None,
            threshs = None,
            mass_ropa = False, # aggiungi dopo
            ):
