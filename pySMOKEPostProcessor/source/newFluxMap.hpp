...
{
    newFluxMap::newFluxMap( OpenSMOKE::ThermodynamicsMap_CHEMKIN& thermodynamicsMapXML,
                            OpenSMOKE::KineticsMap_CHEMKIN& kineticsMapXML) : OpenSMOKE::FluxAnalysisMap(thermodynamicsMapXML, kineticsMapXML)
	{}

    void newFluxMap::ComputeFluxAnalysis()
    {
    ...
    void newFluxMap::ComputeValues(const unsigned int index_j, 
