#include "PostProcessorWrapper_py.hpp"
...
PYBIND11_MODULE(pySMOKEPostProcessor, m)
{
    ...
    py::class_<Sensitivities>(m, "Sensitivity")
        ...
        .def("setNormalizationType", &Sensitivities::SetNormalizationType, py::call_guard<py::gil_scoped_release>())
        .def("setSensitivityType", &Sensitivities::SetSensitivityType, py::call_guard<py::gil_scoped_release>())
        .def("setOrderingType", &Sensitivities::SetOrderingType, py::call_guard<py::gil_scoped_release>())
        ...
        .def("sensitivityAnalysis", &Sensitivities::Sensitivity_Analysis, py::call_guard<py::gil_scoped_release>())
