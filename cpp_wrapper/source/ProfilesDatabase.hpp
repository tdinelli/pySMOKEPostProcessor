...
bool ProfilesDatabase::ReadKineticMechanism(const std::string &folder_name)
{
    ...
    {
        throw std::invalid_argument("The folder of the kinetic mechanism does not contains any kinetics.xml!");
    }
    ...
    {
        throw std::invalid_argument("Output.xml file contains only a subset of the total species in the kinetic mechanism");
    }
