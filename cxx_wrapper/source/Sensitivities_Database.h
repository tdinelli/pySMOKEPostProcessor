...
class Sensitivities_Database {
 public:
  ...
  double NormalizedProfile(const unsigned int &index, const bool &local_normalization,
  ...
  const unsigned int &number_of_variables() const { return number_of_variables_; }
  ...
  const unsigned int &number_of_parameters() const { return number_of_parameters_; }
